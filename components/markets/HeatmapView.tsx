    ...
    <div className="mx-auto max-w-platform px-4 py-6 md:px-6">
      ...
      <div className="flex gap-8 animate-fade-in-up" style={{ animationDelay: "40ms" }}>
        ...
        <div className="min-w-0 flex-1">
          ...
          {/* ── Controls ── */}
          <div className="mb-4 rounded-card border border-border-base bg-bg-secondary p-4 space-y-3">
            {/* Search */}
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded border border-border-base bg-bg-primary pl-7 pr-8 py-1.5 text-sm
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className={`rounded border px-2.5 py-1 text-xs font-medium transition ${
                      sortBy === s
                        ...
                        : "border-border-base bg-bg-primary text-text-secondary hover:bg-bg-hover"
                    }`}
                  >
                    {SORT_LABELS[s][lang]}
                  </button>
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="rounded border border-border-base bg-bg-primary px-2 py-1 text-xs text-text-primary
                ...
                <button
                  ...
                  className="rounded border border-border-base bg-bg-primary px-3 py-1 text-xs
              ...
              {catEntries.map(([cat, tiles]) => {
                ...
                return (
                  <div key={cat}>
                    ...
                    {/* Grid */}
                    <div
                      className="rounded-card border border-border-base"
