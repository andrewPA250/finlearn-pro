...
function EmptyCard({ label }: { label: string }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-card border border-bg-border/15 bg-bg-card/60 px-6 py-10 text-center">
...
export function CalendarView({ data }: CalendarViewProps) {
  ...
  return (
    <div className="mx-auto max-w-platform px-4 py-6 md:px-6">
      ...
      {/* Filter tabs */}
      <div className="mb-4 flex gap-1 overflow-x-auto rounded-card border border-bg-border/15 bg-bg-card/60 p-1 animate-fade-in-up" style={{ animationDelay: "60ms" }}>
